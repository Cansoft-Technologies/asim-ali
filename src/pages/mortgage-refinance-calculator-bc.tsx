            ...
            <main className="content">
              ...
              <Container className='my-5'>
                <Row className='refinance-text my-5'>
                  <Col md={5}>
                    <p>{data?.Refinance?.heroTitle?.split(" ")[0]} <span>{data?.Refinance?.heroTitle?.split(" ")[1]}</span></p>
                  </Col>
                  <Col md={7}>
                ...
                <Row className='coquitlam-grid my-5'>
                  <Col md={7}>
                    <div dangerouslySetInnerHTML={{ __html: data?.Refinance?.aboutText }} >
                    </div>
                  </Col>
                  <Col md={5}>
                    <Image
                ...
                <Row className="product-service">
                  <Col className='mb-5' md={12}>
                    <h2 className='text-center'>{data?.Refinance?.productsTitle}</h2>
                    <p className='text-center'>{data?.Refinance?.productsDescription}</p>
                  </Col>
                  <Col md={3}>
                    <span
                      dangerouslySetInnerHTML={{ __html: data?.Refinance?.productsLeftText }}
                    ></span>
                  ...
                  <Col md={3}>
                    <span
                      dangerouslySetInnerHTML={{ __html: data?.Refinance?.productsRightText }}
                    ></span>
                  </Col>
                </Row>
                
                <Row className='mortgage-broker'>
                <div dangerouslySetInnerHTML={{ __html: data?.Refinance?.brokerSection }} >
                    </div>
                </Row>
                ...
                <Row className='mortgage-broker'>
                <div dangerouslySetInnerHTML={{ __html: data?.Refinance?.contactField }} >
                    </div>
                </Row>
