            ...
            <main className="content">
              ...
              <Container className="my-5">
                <Row className="location-heading">
                  <Col md={8}>
                    <h1>
                      {data?.locations?.locationsBannerTitle.split(" ")[0]}{" "}
                      <span>
                        {data?.locations?.locationsBannerTitle.split(" ")[1]}
                      </span>
                    </h1>
                  </Col>
                ...
                {showMaps == true ? (
                  data?.locations?.locationMap == null ? (
                    ...
                    <div className="listMap">
                      <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2646.855336349133!2d-122.84547831628339!3d49.13573927015761!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5485d162fec05fd5%3A0x44d696e4c0940576!2sMortgage%20Broker%20Surrey%20-%20Asim%20Ali!5e0!3m2!1sen!2sbd!4v1668782884638!5m2!1sen!2sbd"
                        width="100%"
                        height="450"
                      ></iframe>
                    </div>
                  ...
                  <div className="imageList">
                            ...
                            <Col key={a}>
                              ...
                              <div>
                                <a href={fImage?.locationLink?.url}>
                                  <p className="verticall-location">
                                    {fImage?.locationLink?.title}
                                  </p>
                    ...
                    {data?.locations?.secondLocationList == null ? (
                      ...
                      <Row className="location-images mb-5">
                        {data?.locations?.secondLocationList.map(
                          (sImage, b) => {
                            return (
                              <Col key={b}>
                                <Image
