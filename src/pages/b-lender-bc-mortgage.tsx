            ...
            <main className="content">
              ...
              <Container className='my-5'>
                <Row className='refinance-text my-5'>
                  <Col md={5}>
                    <p> <span>{data?.BLender?.heroTitle}</span></p>
                  </Col>
                  <Col md={7}>
                ...
                <Row className='coquitlam-grid my-5'>
                  <Col md={7}>
                    <div dangerouslySetInnerHTML={{ __html: data?.BLender?.aboutText }} >
                    </div>
                  </Col>
                  <Col md={5}>
                    <Image
                ...
                <Row className="product-service">
                  <Col className='mb-5' md={12}>
                    <h2 className='text-center'>{data?.BLender?.productsTitle}</h2>
                    <p className='text-center'>{data?.BLender?.productsDescription}</p>
                  </Col>
                  <Col md={3}>
                    <span
                      dangerouslySetInnerHTML={{ __html: data?.BLender?.productsLeftText }}
                    ></span>
                  ...
                  <Col md={3}>
                    <span
                      dangerouslySetInnerHTML={{ __html: data?.BLender?.productsRightText }}
                    ></span>
                  </Col>
                </Row>
                
                <Row className='mortgage-broker'>
                <div dangerouslySetInnerHTML={{ __html: data?.BLender?.brokerSection }} >
                    </div>
                </Row>
                ...
                <div className='mortgage-broker' dangerouslySetInnerHTML={{ __html: data?.BLender?.reviewHead }} >
                    </div>
                ...
                <Row className='mortgage-broker'>
                <div dangerouslySetInnerHTML={{ __html: data?.BLender?.contactField }} >
                    </div>
                </Row>
