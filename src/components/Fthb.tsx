...
const FirstTimeHomeBuyerCalculator = () => {
  ...
  const calc = () => {
    var FourTimesAnnualIncome = Number((annualIncome * 4).toFixed(0)).toLocaleString('en');
    var resultVal = 0;
    resultVal = homePrice * (propertyType / 100);
    var result = '$' + Number(resultVal.toFixed(0)).toLocaleString('en');

    var downpaymentDolla = parseInt((homePrice * downpaymentPercent) / 100);
    var mortgage = homePrice - downpaymentDolla;
    var message = '';
  ...
  return (
    <div className="uk-section uk-section-small">
      <div className="uk-container uk-container-large">
        <h2 className="pt-5 text-center">First Time Home Buyer Incentive Program Calculator</h2>
        <div className="first-buyer-calculator pt-5">
          <div className="row first-buyer-calculator-card">
            <div className="col-md-6 calculator-left">
              <h2 className="d-block text-center font-weight-bold py-2">Inputs</h2>
              <div className="input-icon-left form-group">
                ...
                <div className="input-group">
                  ...
                  <input
                    ...
                    value={homePrice}
                    onKeyUp={calc}
                    onInput={(e) => (e.target as HTMLInputElement).validity.valid || ((e.target as HTMLInputElement).value = '')}
              ...
              <div className="input-icon-right form-group">
                ...
                <div className="input-group">
                     <input name="downpayment-percent" type="number" className="form-control downpayment-percent" value="10" min="0" max="100" onKeyUp={calc} onInput={(e) => (e.target as HTMLInputElement).validity.valid || ((e.target as HTMLInputElement).value = '')}
                    />
                  ...
                  <div className="input-group">
                     ...
                     <input name="downpayment-dolla" type="number" className="form-control downpayment-dolla padding-left-40" pattern="^\d*(\.\d{0,2})?$" readOnly/>
                  </div>
            ...
            <div className="col-md-6 calculator-right">
              <h2 className="d-block text-center font-weight-bold py-2">Results</h2>
              <h2 className="d-block text-center py-2">You could qualify for...</h2>
              <div className="divider"></div>
              <div className={`results-container text-center py-2 ${isIneligible ? 'text-red-800' : ''}`}>
                <div className="results-header text-center">Shared-Equity Incentive</div>
                <span className="result-value font-2rem text-center py-2">{resultValue}</span>
              </div>
              <div className={`text-center ${isIneligible ? 'd-flex' : 'd-none'}`}>
                <div className={`message-wrapper message-warning`}>
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    style={{ marginRight: '10px', fontSize: '32px', color: '#ED8936' }}
                  >
