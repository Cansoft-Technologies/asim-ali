...
const Meeting = (props: MyProps) => {
  ...
  const dataRates = [
    { term: '6 Months', bankRate: '6.59 %', bankPayment: '$675.29', ourRate: '7.49 %', ourPayment: '$730.93', savings: '$-55.64' },
    { term: '1 Year', bankRate: '7.84 %', bankPayment: '$753.03', ourRate: '6.93 %', ourPayment: '$696.10', savings: '$56.93' },
    { term: '2 Years', bankRate: '7.34 %', bankPayment: '$721.53', ourRate: '6.37 %', ourPayment: '$661.96', savings: '$59.57' },
    { term: '3 Years', bankRate: '6.99 %', bankPayment: '$699.80', ourRate: '5.44 %', ourPayment: '$606.90', savings: '$92.90' },
    { term: '4 Years', bankRate: '6.79 %', bankPayment: '$687.50', ourRate: '5.52 %', ourPayment: '$611.56', savings: '$75.94' },
    { term: '5 Years', bankRate: '6.84 %', bankPayment: '$690.57', ourRate: '4.99 %', ourPayment: '$581.04', savings: '$109.53' },
    { term: '7 Years', bankRate: '7.10 %', bankPayment: '$706.60', ourRate: '6.09 %', ourPayment: '$645.17', savings: '$61.43' },
    { term: '10 Years', bankRate: '7.25 %', bankPayment: '$715.92', ourRate: '6.14 %', ourPayment: '$648.15', savings: '$67.77' }
  ];
