      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8 mb-16">
          ...
          <div className="max-w-xl">
            <div className="text-gray-700" dangerouslySetInnerHTML={{ __html: aboutSection?.description || `If you're looking to buy a home or refinance your current mortgage, you're in the right place. Asim Ali is your go-to mortgage broker in Surrey to guide you through the mortgage journey.` }}>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className={activeTab === "left" ? "order-1" : "order-2"}>
            {activeTab === "left" ? (
              <div className="space-y-4 text-gray-700">
                <p className="space-y-4" dangerouslySetInnerHTML={{ __html: aboutSection?.leftDescription }}></p>
            </div>
            ) : (
              <div className="space-y-4 text-gray-700">
                <p className="space-y-4" dangerouslySetInnerHTML={{ __html: aboutSection?.rightDescription }}></p>
            </div>
            )}
          </div>
          ...
          <div className={activeTab === "left" ? "order-2" : "order-1"}>
            {activeTab === "left" ? (
              ...
              <Image
                src={aboutSection?.leftImage?.sourceUrl || "https://asimaliprod.wpengine.com/wp-content/uploads/2025/06/Mortgage-Broker-Surrey.webp"}
            ...
            : (<div className="relative h-80 w-full rounded-sm overflow-hidden">
              <Image
                src={aboutSection?.rightImage?.sourceUrl || "https://asimaliprod.wpengine.com/wp-content/uploads/2025/06/Best-Mortgage-Broker-in-surrey.webp"}
