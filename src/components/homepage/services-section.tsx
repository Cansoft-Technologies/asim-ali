      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-16 gap-8 items-center">
          <div className="max-w-2xl">
            <h2 className="text-2xl md:text-5xl font-bold mb-4 font-oswald sm:text-center text-start">
          ...
          <div className="mt-4 md:mt-0">
            <Link
              ...
              className=""
            >
              <Button className="bg-[#F0B254] hover:bg-[#e3a94d] !text-xl xl:text-xl text-white font-medium px-8 py-4 rounded-none w-full sm:w-auto text-center min-w-[220px]">
                More Services
              </Button>
            </Link>
          </div>
