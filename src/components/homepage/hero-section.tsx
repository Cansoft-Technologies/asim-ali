...
const HeroSection = ({ menuItems, settings, heroSection }: HeroSectionProps) => {
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden">
      ...
      <div className="text-center z-10 relative">
        <p className="text-xs md:text-sm py-1 bg-white text-[#12143A]">
      ...
      <div className="min-h-[80vh] z-10 relative flex flex-col justify-center items-center">
        <div className="mt-12 sm:mt-16 container mx-auto px-4 sm:px-6 flex flex-col justify-center items-center text-center">
          ...
          <p className="text-base md:text-xl mb-8 sm:mb-10 max-w-2xl text-white/80 text-center" dangerouslySetInnerHTML={{ __html: description ? description : `Looking for a reliable mortgage broker in Surrey? Asim Ali offers mortgage solutions, competitive rates, and expert guidance. Book us to experience the best services.` }}></p>
