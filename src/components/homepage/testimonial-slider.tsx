        ...
        {allTestimonials.map((testimonial, index) => (
          ...
          >
            <div className="bg-transparent backdrop-blur-sm p-3 rounded-md border border-white/10 h-full">
              <p className="text-xs text-white/90 mb-2 line-clamp-2">{testimonial.testimonial}</p>
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-xs font-medium text-white">{testimonial.clientName}</span>
                </div>
