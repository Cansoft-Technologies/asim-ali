...
export default function RoleSection({ roleSection }: { roleSection?: any }) {
    ...
    <section className="w-full bg-white py-16 md:py-24">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">{roleSection?.title || "The Role We Play as Your Specialist Mortgage Brokers"}</h2>

          <div className="text-gray-600 max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: roleSection?.description || `Our mortgage professionals ensure your path to homeownership or mortgage refinancing is easy. We use our
            experience and local market knowledge to select the right solution for you no matter your credit score.` }}></div>
        </div>
