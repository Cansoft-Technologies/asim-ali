    ...
    withPWA({
      ...
      async redirects() {
        return [
          ...
          {
            source: "/125k-salary",
            destination: "/mortgage-affordability/125k-salary",
            permanent: true,
            statusCode: 301,
          },
          {
            source: "/blog/mortgage-affordability",
            destination: "/mortgage-affordability",
            permanent: true,
            statusCode: 301,
          },
          {
            source: "/65k-salary",
            destination: "/mortgage-affordability/65k-salary",
            permanent: true,
            statusCode: 301,
          },
          {
            source: "/mortgage-agent-vs-mortgage-broker",
            destination: "/mortgage-agent-vs-broker",
            permanent: true,
            statusCode: 301,
          },
          {
            source: "/50k-salary",
            destination: "/mortgage-affordability/50k-salary",
            permanent: true,
            statusCode: 301,
          },
          {
          ...
          {
            source: "/b-lender-mortgage-companies",
            destination: "/b-lender-mortgage-companies-blog",
            permanent: true,
            statusCode: 301,
          },
          {
