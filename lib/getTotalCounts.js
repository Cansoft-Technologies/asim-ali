...
export default async function getTotalCounts() {
  ...
  let excludeItems = ['user', 'category','/new-mortgage-for-self-employed-in-bc', '/new-construction-financing', '/new-commercial-mortgage-in-vancouver', '/new-commercial-mortgage-in-bc', '/new-borrow-down-payment-in-bc'];
